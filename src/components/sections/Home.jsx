...
export const Home = () => {
  return (
    <section  id="home" className="min-h-screen flex flex-col items-center justify-center relative  sm:flex-row">
        <div data-aos="fade-up" data-aos-delay="200" className="text-center z-10 px-4">
            <h1 className="text-5xl md:text-7xl font-bold mb-6 p-3 bg-gradient-to-r from-blue-500 to-cyan-400 text-transparent bg-clip-text">Hi, I am Emil Binoy</h1>
        ...
        <img src={profile} data-aos="fade-left" data-aos-delay="200" alt="profile" className='m-5 rounded-full h-60 w-60 border-3 border-solid border-blue-400'/>
    </section>
  )
}
