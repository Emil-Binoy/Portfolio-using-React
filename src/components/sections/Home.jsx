      ...
      <div data-aos="fade-up" data-aos-delay="200" className="text-center z-10 px-4 mb-12 sm:mb-0">
        ...
        <div className="text-xl md:text-2xl font-semibold text-blue-400 mb-10 h-8">
          {showRoles && (
            <Typewriter
              options={{
                strings: ["Web designer", "Full Stack Developer", "React & Tailwind Specialist"],
                autoStart: true,
                loop: true,
                deleteSpeed: 50,
              }}
        ...
        <div className="flex justify-center space-x-4">
          ...
          <a
            href="#contact"
            className="bg-white/5 border border-blue-500/30 text-blue-400 px-2.5 py-2.5 rounded-xl transition duration-300 ease-in-out hover:-translate-y-1 hover:scale-105 hover:bg-blue-500/10 font-bold "
          >
            Contact Me
          </a>
        </div>
