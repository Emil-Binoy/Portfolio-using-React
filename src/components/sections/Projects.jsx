    ...
    <section id="projects" className="min-h-screen flex items-center justify-center py-20">
      <div className="max-w-5xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover;border-blue-500/30 hover:shadow-blue-600 transition">
            <h3 className="text-xl font-bold mb-2">Simple Portfolio</h3>
            <p className="text-gray-400 mb-4">
               My first portfolio used for learning html,css,js and also the tailwind css
            </p>
            <div className="flex flex-wrap gap-2 mb">
              {['HTML','CSS','tailwind CSS','Java Script'].map((tech,key) => (
                <span 
            ...
            <div className="flex justify-between items-center">
              <a href="https://emil-binoy.github.io/portfolio/" className="text-blue-400 hover:text-blue-300 transition-colors">View Project</a>
            </div>
          </div>
        </div>
      </div>
